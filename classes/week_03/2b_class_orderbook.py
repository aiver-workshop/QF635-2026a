...
class OrderBook:
    ...
    def mid(self) -> float:
        """TODO Standard mid from top-of-book."""
        return 0

    def calculate_side_vwap(self, side: list[Tier]) -> float:
        """TODO Helper method to calculate VWAP for a specific list of Tiers."""
        return 0

    def vwap_mid(self) -> float:
        """TODO Calculates a mid-price based on the VWAP of both sides."""
        return 0
